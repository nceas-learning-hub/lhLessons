...
2. Load the data directly from the [EDI Data Repository: Sacramento-San Joaquin Delta Socioecological Monitoring ](https://portal.edirepository.org/nis/mapbrowse?packageid=edi.587.1). Navigate to the link above, scroll down and under *Resources*, hover over the "Download" button for the "Socioecological monitoring data", right click, and save to your data folder.
...
### FOR THE PURPOSES OF RENDERING THE LESSON, WITH EXTRA FOLDER IN PATH.
### THE FOLLOWING CHUNK (echo: true and eval: false) IS FOR WHERE USERS SHOULD
### SAVE FILES.

delta_visits_raw <- read_csv(here::here("data/r_data_visualization/Socioecological_monitoring_data.csv"))

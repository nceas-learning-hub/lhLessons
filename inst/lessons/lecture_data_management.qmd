...
categories: [data-management, reproducibility, synthesis-science, lecture, intermediate]
description: "Covers the Data Life Cycle, data management plans, metadata best practices, and the FAIR and CARE principles for managing synthesis research data."
---
...
![Source: Adapted from Faundeen et al 2013, USGS & DataONE](images/lecture_data_management/data-life-cycle-usgs.png){fig-alt="Data Life Cycle graphic with tools for each step." fig-align="right"}
...
![Source: DataONE Data Life Cycle](images/lecture_data_management/data-life-cycle.png){fig-alt="Data Life Cycle graphic with tools for each step." fig-align="center"}
...
![](images/lecture_data_management/WhyManage-small.png)
...
![](images/lecture_data_management/data-package.png)
...
![](images/lecture_data_management/DataONECNs.png) 
...
![Source: Global Indigenous Data Alliance](images/lecture_data_management/FAIR_CARE.png){width="92%" fig-align="center"}](https://www.gida-global.org/whoweare)
...
[![Source: Fair Teaching Handbook](images/lecture_data_management/FAIRsFAIR.png){width="80%" fig-align="center"}](https://fairsfair.gitbook.io/fair-teaching-handbook/)
...
[![Source: Carroll, S.R., et al, 2020. The CARE Principles for Indigenous Data Governance](images/lecture_data_management/CAREsCARE.png){width="80%" fig-align="center"}](https://datascience.codata.org/articles/10.5334/dsj-2020-043/)
...
## Evaluate a Data Package on the EDI Repository
...
### Evaluate a data package on EDI Data Portal

---
title: Project Management & Team Facilitation
categories: [project-management, team-science, facilitation, lecture, intermediate]
description: "Introduces project management principles adapted for scientific teams, including defining project scope, outlining analyses, and planning work with Gantt charts or GitHub."
---
...
First, though, we'll remind ourselves of _why_ the investment in planning time is so valuable.

::::{.callout-exercise}
### Exercise: Learning From Project "Fails"
...
- Reflect on one of your own project management "fails"
    - What went wrong?
...
![](images/lecture_proj_mgmt_team_science/mind-map.png){fig-alt="Bubble with a central concept or question, surrounded, at the first level, by inputs, outputs or modifiers and at the second level by question, concerns, or implications" width="90%" fig-align="center" .lightbox}
...
![](images/lecture_proj_mgmt_team_science/feasibility-matrix.png){fig-alt="x and y axes, labeled with novelty/importance (Y) and feasibility (x), with project ideas distributed across the resulting space" width="90%" fig-align="center" .lightbox}
...
![Analysis flowchart for a (relatively) straightforward test of controls on Silica exports in streamflow](images/lecture_proj_mgmt_team_science/analysis-flow.png){fig-alt="rectangular boxes containing data sources (Si concentration, streamflow, watershed geometry and land use, watershed precipitation), linked to diamond-shaped boxed describing processing steps, linked to more rectangles with outputs" width="90%" fig-align="center" .lightbox}
...
Let's focus on two tangible modalities for managing a project.
...
![](images/lecture_proj_mgmt_team_science/gantt-image.png){fig-alt="a series of overlapping horizontal colored bars represents the active work periods for several critical project tasks" .lightbox}

### GitHub 

If you're already working in GitHub or GitLab to collaborate on code, why not take advantage of GitHub's project management capabilities?
In GitHub, issues from your repositories can be assigned to projects (which sit at a level above repositories), allowing an overarching view of all the tasks associated with a project.
...
![Kanban board example using GitHub Projects](images/lecture_proj_mgmt_team_science/github-project.png){fig-alt="a series of vertical boards labeled back burner, in queue, active progress, waiting, and done, with cards for specific tasks and individuals and due dates assigned" .lightbox}
...
![Gantt Chart Example using GitHub Projects](images/lecture_proj_mgmt_team_science/github-gantt.png){fig-alt="a series of overlapping horizontal colored bars represents the active work periods for several critical project tasks" .lightbox}

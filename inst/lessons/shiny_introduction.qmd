...
description: "Interactive Shiny web applications in R, covering UI/server structure, reactivity, single- versus two-file app organization, and options for sharing apps."
---

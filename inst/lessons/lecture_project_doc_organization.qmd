...
bibliography: resources/lecture_project_doc_organization/refs.bib
categories: [reproducibility, data-management, project-management, lecture, beginner]
description: "Covers project documentation and file organization best practices for reproducibility, plus an introduction to generative AI use-cases, modalities, and drawbacks in research workflows."
---
...
<img src="images/lecture_project_doc_organization/comic_xkcd-folders.png" alt="One stick figure looks in despair at another's computer where many badly-named files are present. At the bottom text reads 'protip: never look in someone else's documents folder'" width="25%" align="right">

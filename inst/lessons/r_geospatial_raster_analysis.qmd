...
description: "Introduces raster spatial data analysis in R using the terra package, covering raster creation, raster math, modifying spatial parameters, and extracting values."
---

...
categories: [functions, activity, beginner, practice]
description: "Practice exercises for writing, testing, and adding error/warning messages to custom R functions."
---

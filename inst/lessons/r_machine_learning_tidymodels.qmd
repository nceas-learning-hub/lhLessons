...
description: "Introduces the machine learning workflow in R using tidymodels, covering data partitioning, model fitting, cross-validation, model comparison, and hyperparameter tuning."
---

...
categories: [r-basics, lecture, beginner]
description: "Introduces the RStudio interface, running code in the Console and scripts, R objects and data structures, functions, and basic data frame operations."
---
...
-   Navigate the basics of the RStudio interface
-   Run code and basic arithmetic in the Console
-   Explain how and why to write code in an R Script
-   Apply built-in R functions and assign values to objects
...
![Artwork by Allison Horst](images/r_programming_introduction/allison-horst-code-kitchen.png){width="70%" .lightbox align="center"}
...
![](images/r_programming_introduction/save-workspace.png){width="50%" .lightbox align="center"}

**DON'T SAVE!**

By default, when ever you close or switch projects, R studio will prompt you: Do you want to save your workspace image to /"current-project"/ .RData?

RStudio by default wants to save the state of your environment (the objects you have in your environment pane) into the .RData file so that when you open the project again you have the same environment. However, it is **NOT** a good practice to rely on the state of your environment for your script to run and work. If you are coding reproducibly, your script should be able to recreate the state of your environment (all the necessary objects) every time you run it. It is much better to rely on your code recreating the environment than saving the workspace status.

To make sure you're always working reproducibly, change the Global Options configuration for the default to be NEVER SAVE MY WORKSPACE. Go to Tools {{< fa arrow-right >}} Global Options. Under the General menu, select **Never** next to "Save workspace to .RData on exit" (and un-check "Restore .RData into workspace at startup"). This way you won't get asked every time you close a project, instead RStudio knows not to save.

![](images/r_programming_introduction/save-workspace-global-options.png){width="70%" .lightbox align="center"}
...
![](images/r_programming_introduction/RStudio_IDE_env.png){width="70%" .lightbox align="center"}
...
#### Good practice: Remove objects from the environment
...
#### Better practice: Remove objects AND packages from the environment

Note that these tactics only work for objects in your environment, but not for packages that you have loaded.  To ensure a pristine environment (clear of all objects AND packages), you can go to **Session** {{< fa arrow-right >}} **Restart R** (or **Restart R and Clear Output**).  Assuming you've set up your RStudio to **Never** save workspace to .Rdata and unchecked "Restore .RData into workspace at startup," this will clear your environment and give you a fresh R session, ensuring that your script does not rely on the state of the environment to execute correctly.

::: {.callout-tip}
#### Quick Tip

It's good practice to frequently clear your environment. Over time your Global Environmental will fill up with many objects, and this can result in unexpected errors or objects being overridden with unexpected values. Also it's difficult to read / reference your environment when it's cluttered!
:::


## R Packages

![Artwork by Allison Horst](images/r_programming_introduction/allison-horst-r-doorway.png){width="70%" .lightbox align="center"}
...
+----------------------+-----------------------------------------------------------------------------------------------------+
| Learning R Resources | -   [R for Data Science](https://r4ds.hadley.nz/data-visualize.html)                                |
|                      | -   [Introduction to R](http://www.datacarpentry.org/R-ecology-lesson/01-intro-to-r.html)           | 
|                      |    -   from [Data Carpentry's R for data analysis](http://www.datacarpentry.org/R-ecology-lesson/)  |
|                      | -   Jenny Bryan's Stat 545 [course materials](https://stat545.com/r-basics.html)                    |
|                      | -   [Ocean Health Index Data Science Training](http://ohi-science.org/data-science-training/).      |

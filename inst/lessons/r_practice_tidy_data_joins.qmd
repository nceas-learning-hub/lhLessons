...
categories: [tidy-data, data-wrangling, activity, intermediate, practice]
description: "Practice exercises joining bird survey data tables together and identifying primary and foreign keys."
---
...
bird_observations <- read_csv(here::here("data/r_practice_tidy_data_joins/52_pp52_birds_1.csv"))
surveys <- read_csv(here::here("data/r_practice_tidy_data_joins/52_pp52_surveys_1.csv"))
sites <- read_csv(here::here("data/r_practice_tidy_data_joins/52_pp52_sites_1.csv"))
taxalist <- read_csv(here::here("data/r_practice_tidy_data_joins/52_pp52_taxalist_1.csv"))
